...
def parse_args():
    ...
    p.add_argument("--task1", type=Path, default=Path("MC1_59865.pth"))
    p.add_argument("--task2", type=Path, default=Path("Mc2_59865.pth"))
    p.add_argument("--task3", type=Path, default=Path("MC3_59865.pth"))
